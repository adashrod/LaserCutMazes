...
var MazeBuilderComponent = /** @class */ (function () {
    ...
    MazeBuilderComponent.prototype.downloadSvg = function () {
        var file = new File([this.rawSvgSrc || ""], "maze.svg", { type: "image/svg+xml;charset=utf-8" });
        Object(__WEBPACK_IMPORTED_MODULE_3_file_saver__["saveAs"])(file);
        window.ga("send", {
            hitType: "event",
            eventCategory: "Builder",
